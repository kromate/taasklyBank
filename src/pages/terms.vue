	...
	<div class="py-12 sm:py-16 lg:py-24">
		...
		<div class="prose mx-auto max-w-6xl px-4 md:px-7">
			<div class="md:px-8">
				...
				<p>We also encourage you to review the <a class="underline" target="_blank" rel="noreferrer" href="https://support.google.com/analytics/answer/6004245">Google's policy</a> for safeguarding your data</p>
				<h2 class="text-3xl text-gray-900 dark:text-white">
					No Use By Minors
				</h2>
				...
				<p>If you are a copyright owner, or authorized on behalf of one, and you believe that the copyrighted work has been copied in a way that constitutes copyright infringement, please submit your claim via email to support@taaskly.site, with the subject line: “Copyright Infringement” and include in your claim a detailed description of the alleged Infringement as detailed below, under “DMCA Notice and Procedure for Copyright Infringement Claims”</p>
				...
				<p>You can contact our Copyright Agent via email at support@taaskly.site</p>
				<h2 class="text-3xl text-gray-900 dark:text-white">
					Error Reporting & Feedback
				</h2>
				<p>You may provide us either directly at support@taaskly.site or via third party sites and tools with information and feedback concerning errors, suggestions for improvements, ideas, problems, complaints, and other matters related to our Service (“Feedback”). You acknowledge and agree that: (i) you shall not retain, acquire or assert any intellectual property right or other right, title or interest in or to the Feedback; (ii) Company may have development ideas similar to the Feedback; (iii) Feedback does not contain confidential information or proprietary information from you or any third party; and (iv) Company is not under any obligation of confidentiality with respect to the Feedback. In the event the transfer of the ownership to the Feedback is not possible due to applicable mandatory laws, you grant Company and its affiliates an exclusive, transferable, irrevocable, free-of-charge, sub-licensable, unlimited and perpetual right to use (including copy, modify, create derivative works, publish, distribute and commercialize) Feedback in any manner and for any purpose.</p>
